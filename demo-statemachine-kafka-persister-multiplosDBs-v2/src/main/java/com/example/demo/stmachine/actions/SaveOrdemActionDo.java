...
import com.example.demo.stmachine.delegate.SaveOrdemStateDelegate;

import lombok.RequiredArgsConstructor;

@RequiredArgsConstructor
@Component
public class SaveOrdemActionDo implements Action<States, Events> {

	private final SaveOrdemStateDelegate delegate;
