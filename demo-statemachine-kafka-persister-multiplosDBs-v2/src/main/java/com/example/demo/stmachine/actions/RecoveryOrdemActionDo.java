...
import com.example.demo.stmachine.delegate.RecoveryOrdemDelegate;

import lombok.RequiredArgsConstructor;

@RequiredArgsConstructor
@Component
public class RecoveryOrdemActionDo implements Action<States, Events>{

	private final RecoveryOrdemDelegate delegate;
