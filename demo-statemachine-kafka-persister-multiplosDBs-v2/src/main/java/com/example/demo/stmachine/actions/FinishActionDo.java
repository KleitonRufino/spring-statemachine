...
import com.example.demo.stmachine.delegate.FinishDelegate;

import lombok.RequiredArgsConstructor;

@RequiredArgsConstructor
@Component
public class FinishActionDo implements Action<States, Events>{

	private final FinishDelegate delegate;
