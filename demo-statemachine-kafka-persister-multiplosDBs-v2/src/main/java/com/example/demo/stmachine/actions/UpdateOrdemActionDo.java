...
import com.example.demo.stmachine.delegate.UpdateOrdemStateDelegate;

import lombok.RequiredArgsConstructor;

@RequiredArgsConstructor
@Component
public class UpdateOrdemActionDo implements Action<States, Events>{

	private final UpdateOrdemStateDelegate delegate;
