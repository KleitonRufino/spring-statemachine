...
import com.sysmap.firstcall.stmachine.task.UpdateOfferStateTask;
...
@Component
public class UpdateOfferAction implements Action<States, Events> {

	private final UpdateOfferStateTask delegate;
