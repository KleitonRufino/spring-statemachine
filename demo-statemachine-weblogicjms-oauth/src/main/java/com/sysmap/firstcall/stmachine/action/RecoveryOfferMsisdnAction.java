...
import com.sysmap.firstcall.stmachine.task.RecoveryOfferMsisdnTask;
...
@Component
public class RecoveryOfferMsisdnAction implements Action<States, Events> {

	private final RecoveryOfferMsisdnTask delegate;
	...
	public void execute(StateContext<States, Events> context) {
		...
		try {
			...
			machine.sendEvent(Events.RECUPERANDO_OFFERS_STATUS);
