...
//	}
	...
	public synchronized void startAndSendEvent(String idMachine, Events nextEvent, Map<String, Object> param) {
	...
	public void sendEvent(StateMachine<States, Events> machine, Events nextEvent, Map<String, Object> param) {
	...
	public synchronized void release(String machineId) {
