...
import com.sysmap.firstcall.stmachine.task.SaveOfferStateTask;
...
@Component
public class SaveOfferAction implements Action<States, Events> {

	private final SaveOfferStateTask delegate;
